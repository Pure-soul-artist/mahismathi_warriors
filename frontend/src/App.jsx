        ...
        element={
          ...
          "
                >
                  ...
                  <button
                    onClick={logout}
                    className="absolute right-8 top-8 z-20 text-sm text-sky-800 hover:text-sky-600 font-bold px-4 py-2 bg-white/80 rounded-lg backdrop-blur-md shadow-sm transition-all"
                  >
                    Logout
                  </button>
